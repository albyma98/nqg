...
export function TypingText({ text, speed = typing.normal, className, loading, onComplete }) {
    ...
    return (_jsxs("button", { type: "button", onClick: () => {
        ...
        }, className: cn('w-full text-left', className), children: [_jsx("span", { children: visible }), loading ? _jsx("span", { className: "animate-pulse", children: "..." }) : null, showCursor ? _jsx("span", { className: "animate-pulse", children: "|" }) : null] }));
}
